...
const ScrollStack = ({
  ...
  const updateCardTransforms = useCallback(() => {
    ...
    cardsRef.current.forEach((card, i) => {
      ...
      // We no longer calculate dynamic translateY for pinning because CSS position: sticky handles it!
      // We only apply the constant stack distance offset.
      if (isPinned || scrollTop > pinEnd) {
      ...
      if (hasChanged) {
        ...
        const innerCard = card.querySelector('.scroll-stack-card') as HTMLElement;
        if (innerCard) {
          innerCard.style.transform = transform;
          innerCard.style.filter = filter;
        }
